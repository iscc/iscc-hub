...
class DeclarationAck(Schema):
    ...
    seq: Annotated[
        int,
        Field(
            description="Zero-based leaf index (sequence number) of the record in the log.\n\n**Start:** 0 (first record)\n**Guarantee:** gapless — a missing integer means a missing record\n",
            examples=[0, 42],
            ge=0,
        ),
    ]
